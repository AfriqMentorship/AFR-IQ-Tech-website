...
export const localProducts = [
  // --- EXISTING COLLECTION (DIVERSIFIED) ---
  {
    ...
    recommended_for: ['Advanced Website Development', 'Software Engineering', 'Cyber Security (Comptia Security+)'],
  ...
  },
  {
    ...
    recommended_for: ['Software Engineering', 'Data Analysis', 'Website Development'],
  ...
  },
  {
    ...
    recommended_for: ['Digital Marketing', 'Graphics Design', 'Business Computing (QuickBooks/Tally)'],
  ...
  },
  {
    ...
    recommended_for: ['Networking (CCNA Prep)', 'Linux Systems Administration', 'Cyber Security (Comptia Security+)'],
  ...
  },
  {
    ...
    recommended_for: ['Business Computing (QuickBooks/Tally)', 'Website Development', 'Data Analysis'],
  ...
  },
  {
    ...
    recommended_for: ['Website Development', 'Software Engineering', 'Computer Fundamentals'],
  ...
  },
  {
    ...
    recommended_for: ['Computer Fundamentals', 'Computer Repair And Maintenance'],
  ...
  },
  {
    ...
    recommended_for: ['Digital Marketing', 'Data Analysis', 'Business Computing (QuickBooks/Tally)'],
  ...
  // --- NEW ADDITIONS (APPLE & MICROSOFT) ---
  {
    ...
    recommended_for: ['Advanced Website Development', 'Video Editing and Photography', 'Graphics Design'],
  ...
  },
  {
    ...
    recommended_for: ['Digital Marketing', 'Business Computing (QuickBooks/Tally)', 'Data Analysis'],
